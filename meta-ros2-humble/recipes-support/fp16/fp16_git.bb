...
SRC_URI = " \
    git://github.com/luxonis/FP16.git;protocol=https;name=fp16;branch=master \
    git://github.com/Maratyszcza/psimd.git;protocol=https;destsuffix=git/psimd;name=psimd;branch=master \
"
