...
# matches with: https://github.com/ros2-gbp/reach_ros2-release/archive/release/humble/reach_ros/1.3.2-2.tar.gz
ROS_BRANCH ?= "branch=release/humble/reach_ros"
SRC_URI = "git://github.com/ros2-gbp/reach_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "315a116219adbad56a665952a453bc365f19bccb"
S = "${WORKDIR}/git"
