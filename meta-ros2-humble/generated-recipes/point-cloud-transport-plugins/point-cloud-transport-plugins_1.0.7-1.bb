...
# matches with: https://github.com/ros2-gbp/point_cloud_transport_plugins-release/archive/release/humble/point_cloud_transport_plugins/1.0.7-1.tar.gz
...
SRCREV = "3f54df0dfbd57c1157cd92db5fd71a38ccb1bf83"
S = "${WORKDIR}/git"
