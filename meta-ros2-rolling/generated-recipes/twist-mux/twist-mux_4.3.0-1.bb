...
# matches with: https://github.com/ros2-gbp/twist_mux-release/archive/release/rolling/twist_mux/4.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/twist_mux"
SRC_URI = "git://github.com/ros2-gbp/twist_mux-release;${ROS_BRANCH};protocol=https"
SRCREV = "05ceda92207fbe8977294afefed2d2fae8bd3ba1"
S = "${WORKDIR}/git"
