...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/lifecycle_py/0.33.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "456347c7b3e7e1987bd7ef5ce6dd48da6b694f11"
S = "${WORKDIR}/git"
