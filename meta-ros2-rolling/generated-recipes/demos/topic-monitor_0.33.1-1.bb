...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/topic_monitor/0.33.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/topic_monitor"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "9521c326fe858c4001fcf67bdf69f8646aea89b3"
S = "${WORKDIR}/git"
