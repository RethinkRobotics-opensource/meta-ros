...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/demo_nodes_py/0.33.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/demo_nodes_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "b0dae4450d468e40a4a5e9bd7078ec2820b7842d"
S = "${WORKDIR}/git"
