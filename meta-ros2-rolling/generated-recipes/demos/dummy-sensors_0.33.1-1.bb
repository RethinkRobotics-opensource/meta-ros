...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/dummy_sensors/0.33.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/dummy_sensors"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "2e8c86d6b369c1286c74da606fbbbe939a81734c"
S = "${WORKDIR}/git"
