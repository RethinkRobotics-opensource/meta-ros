...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/demo_nodes_cpp/0.33.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/demo_nodes_cpp"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "4416986beb630ac56e716a39df90ea6e7307671e"
S = "${WORKDIR}/git"
