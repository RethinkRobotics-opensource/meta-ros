...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/rolling/kdl_parser/2.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "a8fe6ae718f6e115e07c475620e4d7dcab8cfcdb"
S = "${WORKDIR}/git"
