...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_servo/2.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_servo"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7f00f0500c84415ce04de948db5e7893868cb5c4"
S = "${WORKDIR}/git"
