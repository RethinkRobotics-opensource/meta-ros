...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_common/2.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/moveit_common"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "6ede403550260dfab3e265b0939ad667a0bcac56"
S = "${WORKDIR}/git"
