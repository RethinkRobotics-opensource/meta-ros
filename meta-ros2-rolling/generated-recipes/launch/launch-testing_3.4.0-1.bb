...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_testing/3.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/launch_testing"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "c16855174d9f403687535c4a58f8432df562cc25"
S = "${WORKDIR}/git"
