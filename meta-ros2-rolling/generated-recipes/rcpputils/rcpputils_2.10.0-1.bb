...
# matches with: https://github.com/ros2-gbp/rcpputils-release/archive/release/rolling/rcpputils/2.10.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rcpputils"
SRC_URI = "git://github.com/ros2-gbp/rcpputils-release;${ROS_BRANCH};protocol=https"
SRCREV = "0021dd2d150e9e5f9196b9be308c751ee9230f52"
S = "${WORKDIR}/git"
