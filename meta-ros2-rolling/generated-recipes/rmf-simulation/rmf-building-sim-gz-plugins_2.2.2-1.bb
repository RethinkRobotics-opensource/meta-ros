...
# matches with: https://github.com/ros2-gbp/rmf_simulation-release/archive/release/rolling/rmf_building_sim_gz_plugins/2.2.2-1.tar.gz
...
SRCREV = "f8d1faf75223f81f20d3732ee297fc92f9a9acfe"
S = "${WORKDIR}/git"
