...
# matches with: https://github.com/ros2-gbp/pinocchio-release/archive/release/rolling/pinocchio/2.6.21-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/pinocchio"
SRC_URI = "git://github.com/ros2-gbp/pinocchio-release;${ROS_BRANCH};protocol=https"
SRCREV = "40272defc4ffe40eb8612a5dea7ace35ad0505ac"
S = "${WORKDIR}/git"
