...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui/2.7.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "af1bd51cb8e3a94eee40ef6a2029a7ba28d3fcaf"
S = "${WORKDIR}/git"
