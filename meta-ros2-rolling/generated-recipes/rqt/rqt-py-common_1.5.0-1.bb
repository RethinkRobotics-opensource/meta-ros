...
# matches with: https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt_py_common/1.5.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_py_common"
SRC_URI = "git://github.com/ros2-gbp/rqt-release;${ROS_BRANCH};protocol=https"
SRCREV = "a2a6718ec9a261cbae859441c91d61908f3310e9"
S = "${WORKDIR}/git"
