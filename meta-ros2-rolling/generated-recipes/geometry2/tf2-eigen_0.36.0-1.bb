...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_eigen/0.36.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_eigen"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "fd0e6e703cd98994041078137d9ec6af91bc86bd"
S = "${WORKDIR}/git"
