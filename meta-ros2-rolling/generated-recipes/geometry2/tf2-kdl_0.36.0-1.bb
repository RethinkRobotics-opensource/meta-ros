...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_kdl/0.36.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_kdl"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "fb50dbc15b0c10d9f9d49145eae69d01e7fe5e26"
S = "${WORKDIR}/git"
