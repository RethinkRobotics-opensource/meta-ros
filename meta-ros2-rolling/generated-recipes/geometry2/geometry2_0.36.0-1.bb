...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/geometry2/0.36.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/geometry2"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "fa3baab6362841206448c3978bf6ae78c0074f2d"
S = "${WORKDIR}/git"
