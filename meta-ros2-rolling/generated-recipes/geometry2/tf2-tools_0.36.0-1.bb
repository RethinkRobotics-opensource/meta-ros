...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_tools/0.36.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7e2e206cbecea979a38d86a90908e94ba9f8617d"
S = "${WORKDIR}/git"
