...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_msgs/0.36.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_msgs"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b8eaef5691bebb392defae75f3677e4e8aded9ce"
S = "${WORKDIR}/git"
