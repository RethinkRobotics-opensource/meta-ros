...
# matches with: https://github.com/ros2-gbp/pluginlib-release/archive/release/rolling/pluginlib/5.4.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/pluginlib"
SRC_URI = "git://github.com/ros2-gbp/pluginlib-release;${ROS_BRANCH};protocol=https"
SRCREV = "3d9879e4ba3d5c9cacd5ce562d2c5bf182db257a"
S = "${WORKDIR}/git"
