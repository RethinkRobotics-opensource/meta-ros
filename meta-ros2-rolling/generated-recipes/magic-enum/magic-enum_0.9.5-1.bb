...
# matches with: https://github.com/nobleo/magic_enum-release/archive/release/rolling/magic_enum/0.9.5-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/magic_enum"
SRC_URI = "git://github.com/nobleo/magic_enum-release;${ROS_BRANCH};protocol=https"
SRCREV = "82f3d90a29dc688a448b85df76b2361ed3e2edeb"
S = "${WORKDIR}/git"
