...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_parser/4.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "5d13930c969c46b4e6ad2ebb515bdfe5bdcfdb05"
S = "${WORKDIR}/git"
