...
# matches with: https://github.com/ros2-gbp/rqt_shell-release/archive/release/rolling/rqt_shell/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_shell"
SRC_URI = "git://github.com/ros2-gbp/rqt_shell-release;${ROS_BRANCH};protocol=https"
SRCREV = "664c89adb3cd10981d61a7ea6ad83b964b236ac4"
S = "${WORKDIR}/git"
