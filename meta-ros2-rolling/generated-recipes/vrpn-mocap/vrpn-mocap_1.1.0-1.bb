...
# matches with: https://github.com/ros2-gbp/vrpn_mocap-release/archive/release/rolling/vrpn_mocap/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/vrpn_mocap"
SRC_URI = "git://github.com/ros2-gbp/vrpn_mocap-release;${ROS_BRANCH};protocol=https"
SRCREV = "7009985b7ee679983d5a68cfde509ec4661ae722"
S = "${WORKDIR}/git"
