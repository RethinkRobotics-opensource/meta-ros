...
# matches with: https://github.com/ros2-gbp/Pangolin-release/archive/release/rolling/pangolin/0.9.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/pangolin"
SRC_URI = "git://github.com/ros2-gbp/Pangolin-release;${ROS_BRANCH};protocol=https"
SRCREV = "103481466855a69af12487493ded7f85132cff1d"
S = "${WORKDIR}/git"
